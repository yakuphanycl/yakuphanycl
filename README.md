...
<sub>Auto-updated daily via GitHub Actions — last refresh: 2026-04-20 07:52 UTC</sub>
...
|---|---|---|
| [**WinstonRedGuard**](https://github.com/yakuphanycl/WinstonRedGuard) | Local-first Python monorepo — 59 apps, 5300+ tests | ![CI](https://img.shields.io/github/actions/workflow/status/yakuphanycl/WinstonRedGuard/ci.yml?label=CI&style=flat-square) |
