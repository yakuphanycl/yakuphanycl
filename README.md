...
Building local-first Python tools. 70 apps in one governed monorepo.

<sub>Auto-updated daily via GitHub Actions — last refresh: 2026-04-15 07:20 UTC</sub>
...
|---|---|
| **70** apps | **3800+** tests |
| **all passing** CI | **70/70** governance |
...
|---|---|---|
| [**WinstonRedGuard**](https://github.com/yakuphanycl/WinstonRedGuard) | Local-first Python monorepo — 70 apps, 3800+ tests | ![CI](https://img.shields.io/github/actions/workflow/status/yakuphanycl/WinstonRedGuard/ci.yml?label=CI&style=flat-square) |
...
- **153** commits in the last 30 days across all repos
- **2** packages on PyPI
